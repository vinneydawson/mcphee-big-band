...
Issues and PRDs are tracked as GitHub issues (`gh` CLI) in `vinneydawson/mcphee-big-band`; external PRs are not a triage surface. See `docs/agents/issue-tracker.md`.
